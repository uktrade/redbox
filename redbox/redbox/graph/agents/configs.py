...
from redbox.models.chain import ConfiguredAgentPlan, FeedbackEvalDecision
...
class PromptVariable(BaseModel):
    ...
    plan: bool = Field(description="A plan generated by planner agent based from user request", default=False)
...
prompt_configs: Dict[str, PromptConfig] = {
    ...
    "Decision_agent": PromptConfig(
        system=prompts.USER_FEEDBACK_EVAL_PROMPT,
        prompt_vars=PromptVariable(plan=True, user_feedback=True, format_instructions=True),
    ),
}
...
agent_configs: Dict[str, AgentConfig] = {
    ...
    "Decision_Agent": AgentConfig(
        name="Decision_agent",
        description="Classifying feedback from user into approve, modify or reject",
        prompt=prompt_configs["Decision_agent"],
