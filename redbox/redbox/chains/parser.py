...
class StreamingJsonOutputParser(BaseCumulativeTransformOutputParser[Any]):
    ...
    def _transform(self, input: Iterator[Union[str, BaseMessage]]) -> Iterator[Any]:
        ...
        # dur = f"Total time: {end_time - start_time:.4f} seconds"
        ...
        #     if acc_text.count("{") > 0 and acc_text.count("{") == acc_text.count("}"):
        ...
        # dur2 = f"Total time: {end_time_new - start_time_new:.4f} seconds"
