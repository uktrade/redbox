...
+Analyse carefully the database schema before generating the SQL query. Here is the data schema including all table nam
es and columns and any Excel formatting extracted from the source document: {db_schema}
+If any Excel formulas are provided in the database schema please use this information to infer relationships between c
olumns in the database. If you see any non-empty error below obtained by executing your previous SQL query, please correct your SQL query.
SQL error: {sql_error}
"""
