...
You are in skill mode using '{{skill_agent_name}}' make sure to tell the user when stating your capabilities or responding to a greeting. Skill description: {{skill_agent_description}}.
"""
