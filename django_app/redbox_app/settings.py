...
AWS_TRANSCRIBE_ACCESS_KEY_ID = env.str("AWS_TRANSCRIBE_ACCESS_KEY_ID", "")
AWS_TRANSCRIBE_SECRET_ACCESS_KEY = env.str("AWS_TRANSCRIBE_SECRET_ACCESS_KEY", "")
AWS_SESSION_TOKEN = env.str("AWS_SESSION_TOKEN", "")
AWS_EXPIRATION_TIMESTAMP = env.str("AWS_EXPIRATION_TIMESTAMP", "")
