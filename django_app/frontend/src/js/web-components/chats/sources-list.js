...
export class SourcesList extends HTMLElement {
   ...
   * @param {string} chatId
   */
  add = (fileName, url, matchingText, chatId) => {
      ...
      html += `
        <li class="govuk-!-margin-bottom-0">
          <a class="iai-chat-bubbles__sources-link govuk-link" 
             href="/citations/${chatId}/#${source.footnoteId}" 
             id="footnote-${source.footnoteId}" 
             data-text="${this.escapeHtmlAttribute(source.matchingText)}">
