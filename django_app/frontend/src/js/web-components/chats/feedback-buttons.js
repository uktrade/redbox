    ...
    this.closest(".chat-actions-container").insertAdjacentHTML("afterend",`
      <div class="govuk-form-group feedback-container feedback-container--2" tabindex="-1">
        <fieldset class="govuk-fieldset feedback__chips-container feedback__chips-container-${this.dataset.id} feedback__negative">
          <legend class="govuk-fieldset__legend govuk-fieldset__legend--s ids-text-s">Select all that apply about the response</legend>
          <div class="ids-radio-groups-container ids-text-xs">
            <!-- Factuality Group -->
            <div class="govuk-radios govuk-radios--small ids-radio-flex-container feedback__chip-group">
