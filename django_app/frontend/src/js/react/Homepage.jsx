...
const GovukButton = () => {
    return (
        <button type="submit" className="govuk-button govuk-button--secondary govuk-!-margin-bottom-0 rb-banner__button" data-module="govuk-button" data-prevent-double-click="true">
            Sign in
        </button>
    )
}
                ...
                <div className="govuk-width-container">
                    <div className="govuk-grid-row">
                        <div className="govuk-grid-column-two-thirds">
                                <h1 className="govuk-heading-xl govuk-!-margin-bottom-7">Use Artificial Intelligence (AI) to interact with official sensitive level documents from your own document set</h1>
                                <p className="govuk-body-l govuk-!-margin-bottom-7">You may summarise documents, ask questions related to one or more documents, and chat directly with the AI to assist you in your work. You can use up to, and including, Official documents.</p>
                                <div className="rb-banner__links">
                                        <GovukButton />
                                </div>
                        </div>
                    </div>
            ...
            <div className="govuk-width-container">
                <div className="govuk-grid-row">
                    <div className="govuk-grid-column-two-thirds">
                        ...
                        <h2 className="govuk-heading-m govuk-!-margin-top-5 govuk-!-padding-top-5">Upload</h2>
                        <p className="govuk-body ">Easily upload a wide range of document formats into your personal Redbox.</p>
                        <h2 className="govuk-heading-m govuk-!-margin-top-5 govuk-!-padding-top-5">Chat</h2>
                        <p className="govuk-body">You can communicate with your Redbox and ask questions of the documents contained within. Use Redbox to unlock deeper insights in the various documents you have uploaded, pulling together summaries of individual or combined documents.</p>
                        <h2 className="govuk-heading-m govuk-!-margin-top-5 govuk-!-padding-top-5">Secure</h2>
                        <p className="govuk-body">Redbox is built in our secure and private cloud which enables you to upload, up to, and including, official sensitive documents in your Redbox.</p>
            ...
            <div className="govuk-width-container">
                <div className="govuk-grid-row">
                    <div className="govuk-grid-column-two-thirds">
                        ...
                        <p className="govuk-body ">Responses to these FAQs about Redbox were generated using Redbox.</p>
                    </div>
                </div>
                <div className="govuk-accordion" data-module="govuk-accordion" id="faq">
                    <div className="govuk-accordion__section">
                        <div className="govuk-accordion__section-header">
                            <h2 className="govuk-accordion__section-heading">
                                <span className="govuk-accordion__section-button" id="faq-question-1">
                                    What is Redbox?
                                </span>
                            </h2>
                        </div>
                        <div className="govuk-accordion__section-content" id="faq-content-1">
                    ...
                    <div className="govuk-accordion__section">
                        <div className="govuk-accordion__section-header">
                            <h2 className="govuk-accordion__section-heading">
                                <span className="govuk-accordion__section-button" id="faq-question-2">
                                    What is Generative AI?
                                </span>
                            </h2>
                        </div>
                        <div className="govuk-accordion__section-content" id="faq-content-2">
                            <p className="govuk-body">
                    ...
                    <div className="govuk-accordion__section">
                        <div className="govuk-accordion__section-header">
                            <h2 className="govuk-accordion__section-heading">
                                <span className="govuk-accordion__section-button" id="faq-question-3">
                                    Do I need technical skills to use Redbox?
                                </span>
                            </h2>
                        </div>
                        <div className="govuk-accordion__section-content" id="faq-content-3">
                            <p className="govuk-body">
                    ...
                    <div className="govuk-accordion__section">
                        <div className="govuk-accordion__section-header">
                            <h2 className="govuk-accordion__section-heading">
                                <span className="govuk-accordion__section-button" id="faq-question-4">
                                    What can I and can’t I share with Redbox?
                                </span>
                            </h2>
                        </div>
                        <div className="govuk-accordion__section-content" id="faq-content-4">
                            <p className="govuk-body">
                                For the moment, you can share text and documents up to the official sensitive classification level.  Take care to check before sharing
                            ...
                            <p className="govuk-body">
                                ...
                                <a href="" className="govuk-link">video</a>.  If
                                you are unsure whether you are processing personal data, you should contact the <a href="" className="govuk-link">Data Protection Team</a>
                                to check.
                            </p>
                        </div>
                    </div>
                    <div className="govuk-accordion__section">
                        <div className="govuk-accordion__section-header">
                            <h2 className="govuk-accordion__section-heading">
                                <span className="govuk-accordion__section-button" id="faq-question-5">
                                    What is a ‘hallucination’?
                                </span>
                            </h2>
                        </div>
                        <div className="govuk-accordion__section-content" id="faq-content-5">
                            <p className="govuk-body">
                    ...
                    <div className="govuk-accordion__section">
                        <div className="govuk-accordion__section-header">
                            <h2 className="govuk-accordion__section-heading">
                                <span className="govuk-accordion__section-button" id="faq-question-6">
                                    What are the main things Redbox can do? 
                                </span>
                            </h2>
                        </div>
                        <div className="govuk-accordion__section-content" id="faq-content-6">
                            <p className="govuk-body">
                            ...
                            <h4 className="govuk-heading-m govuk-!-margin-top-1">Chat</h4>
                            <p className="govuk-body">
                            ...
                            <h4 className="govuk-heading-m govuk-!-margin-top-1">Summarise</h4>
                            <p className="govuk-body">
                            ...
                            <div className="govuk-inset-text">
                                ...
                                follow a particular kind of format in its response.  Here's an example prompt - imagine you have selected an HR Policy document on taking leave at DBT: <br></br><br></br>
                                <i>@summarise this HR policy from the perspective of a line manager, as my line report has asked to take extended leave and I want to know what steps I need to take.</i><br></br><br></br>
                            ...
                            <h4 className="govuk-heading-m govuk-!-margin-top-1">Search</h4>
                            <p className="govuk-body">
                    ...
                    <div className="govuk-accordion__section">
                        <div className="govuk-accordion__section-header">
                            <h2 className="govuk-accordion__section-heading">
                                <span className="govuk-accordion__section-button" id="faq-question-7">
                                    What can’t Redbox do? 
                                </span>
                            </h2>
                        </div>
                        <div className="govuk-accordion__section-content" id="faq-content-7">
                            <p className="govuk-body">
                    ...
                    <div className="govuk-accordion__section">
                        <div className="govuk-accordion__section-header">
                            <h2 className="govuk-accordion__section-heading">
                                <span className="govuk-accordion__section-button" id="faq-question-8">
                                    Why can Redbox get things wrong? 
                                </span>
                            </h2>
                        </div>
                        <div className="govuk-accordion__section-content" id="faq-content-8">
                            <p className="govuk-body">
