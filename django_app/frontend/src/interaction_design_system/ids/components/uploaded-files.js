...
export class UploadedFiles extends HTMLElement {
    constructor() {
        ...
        this.templateId = 'ids-uploaded-files-template';
     ...
     */
    addFile(name) {
        const uploadedFile = /** @type {UploadedFile} */ (document.createElement("ids-uploaded-file"));
...
customElements.define("ids-uploaded-files", UploadedFiles);
