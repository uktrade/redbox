...
Example response:
If citations are available: {{"answer": "your complete answer here including any 'ref_N' citation markers inline as required in plain text", "citations": [list_of_citations], "answer_process": "Outline the processes you took to produce the answer within 200 words or less, highlight any process that were unsuccessful in answering the user question"}}.
...
If no citations are available or needed, return an empty array for citations like this: {{"answer": "your complete answer here with no citation markers", "citations": [], "answer_process": "Outline the processes you took to produce the answer within 200 words or less, highlight any process that were unsuccessful in answering the user question"}}.
...
NEW_ROUTE_RETRIEVAL_SYSTEM_PROMPT = """Answer user question using the provided context. Outline the processes you took to produce the answer within 200 words or less, highlight any process that were unsuccessful in answering the user question"""
