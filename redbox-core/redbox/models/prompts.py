...
- Each citation must be shown in the answer using a unique identifier in the format "ref_N" where N is an incrementing number starting from 1. DO NOT REPEAT CITATIONS OR CITATION IDENTIFIERS.
