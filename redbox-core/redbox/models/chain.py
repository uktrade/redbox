...
class StructuredResponseWithCitations(BaseModel):
    ...
    answer_process: str = Field(description="outline the processes you took to produce the answer, if you cannot outline the processes taken explain why", default="")
